...
app.controller("reportKPIResumen", function ($scope, unitOfWork, $location, $route, $filter, $window, $rootScope, $modal, toaster) {
    function init() {
        var request = {};
        ...
        //unitOfWork.Reports.complexPost(["KpiResumen"], request).success(function (data) {
        //    $scope.data = data;
        //    console.log(data);
        ...
        $scope.$watch("request", function(val)
        {
            ...
            unitOfWork.Reports.complexPost(["KpiResumen"], val).success(function (data) {
            $scope.data = data;
            console.log(data);
            $scope.OTD = data.FurgonesATiempo > 0 ? data.FurgonesATiempo / data.Furgones * 100: 0;
